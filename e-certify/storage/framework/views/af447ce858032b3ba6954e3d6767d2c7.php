...
<?php $__blaze->pushData(['x-model' => 'code','length' => '6','name' => 'code','label' => 'OTP Code','label:sr-only' => true,'class' => 'mx-auto']); ?>
<?php _215be5542031f5ed145483bfb57a1c3a($__blaze, ['x-model' => 'code','length' => '6','name' => 'code','label' => 'OTP Code','label:sr-only' => true,'class' => 'mx-auto'], [], ['label:sr-only'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
                        </div>
                    </div>
...
<?php $__blaze->pushData(['type' => 'text','name' => 'recovery_code','x-ref' => 'recovery_code','x-bind:required' => 'showRecoveryInput','autocomplete' => 'one-time-code','x-model' => 'recovery_code']); ?>
<?php _51210aa5c05ec12399d4c8c9d1e4aa8a($__blaze, ['type' => 'text','name' => 'recovery_code','x-ref' => 'recovery_code','x-bind:required' => 'showRecoveryInput','autocomplete' => 'one-time-code','x-model' => 'recovery_code'], [], [], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
                        </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="[:where(&amp;)]:font-normal [:where(&amp;)]:text-sm text-red-600 dark:text-red-400" data-flux-text  data-color="red" ><?php echo e($message); ?></p>
                        <?php unset($message);
...
<?php endif; ?>
<?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\resources\views\livewire\auth\two-factor-challenge.blade.php ENDPATH**/ ?>