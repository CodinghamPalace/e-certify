    ...
    <?php echo e(__('Confirm password')); ?>
        ...
        <div class="w-full relative block group/input" data-flux-input>
            ...
            <input
                ...
                class="w-full border rounded-lg block disabled:shadow-none dark:shadow-none appearance-none text-base sm:text-sm py-2 h-10 leading-[1.375rem] ps-3 pe-10 bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] text-zinc-700 disabled:text-zinc-500 placeholder-zinc-400 disabled:placeholder-zinc-400/70 dark:text-zinc-300 dark:disabled:text-zinc-400 dark:placeholder-zinc-400 dark:disabled:placeholder-zinc-500 shadow-xs border-zinc-200 border-b-zinc-300/80 disabled:border-b-zinc-200 dark:border-white/10 dark:disabled:border-white/5 data-invalid:shadow-none data-invalid:border-red-500 dark:data-invalid:border-red-500 disabled:data-invalid:border-red-500 dark:disabled:data-invalid:border-red-500" <?php if (($__blazeAttr = __('Confirm password')) !== false && !is_null($__blazeAttr)): ?>label="<?php echo e($__blazeAttr === true ? 'label' : $__blazeAttr); ?>"<?php endif; unset($__blazeAttr); ?> required="required" autocomplete="new-password" <?php if (($__blazeAttr = __('Confirm password')) !== false && !is_null($__blazeAttr)): ?>placeholder="<?php echo e($__blazeAttr === true ? 'placeholder' : $__blazeAttr); ?>"<?php endif; unset($__blazeAttr); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\resources\views/livewire/auth/reset-password.blade.php ENDPATH**/ ?>