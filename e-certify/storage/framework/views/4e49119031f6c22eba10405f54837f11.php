<div>
        ...
        <div class="d-flex gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingCount > 0): ?>
                <button wire:click="confirmBulkSend" type="button" class="btn btn-sm btn-outline-primary d-flex align-items-center justify-content-center gap-2"
                    ...
                    <i class="bi bi-envelope-paper"></i> Send All Pending (<?php echo e($pendingCount); ?>)
                </button>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($participant->status === 'generated'): ?>
                                        <button wire:click="confirmSingleSend(<?php echo e($participant->id); ?>)" type="button" class="btn btn-sm btn-outline-success py-0 px-2"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-4" style="font-size:.88rem;">
                    ...
                    <p class="mb-0">Are you sure you want to queue <strong><?php echo e($pendingCount); ?></strong> certificates for background delivery to participants?</p>
                </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showSingleSendModal): ?>
