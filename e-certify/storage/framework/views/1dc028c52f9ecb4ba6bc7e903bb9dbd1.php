    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;margin:0 auto;border:1px solid #e0e7ef;border-radius:12px;box-shadow:0 6px 24px rgba(13,71,161,0.08);">
        <tr>
            <td style="padding:32px 32px 24px 32px;text-align:center;border-bottom:1px solid #e0e7ef;background:linear-gradient(120deg,#ffffff 0%,#e3f2fd 100%);">
                ...
                <div style="font-size:15px;color:#1976d2;margin-top:4px;"><?php echo e($systemName ?? config('app.name', 'e-Certify System')); ?></div>
            </td>
        </tr>
        <tr>
            <td style="padding:32px;">
                ...
                <p style="margin:0 0 20px 0;line-height:1.6;">
                    This verification link will expire in <?php echo e($expiresInMinutes); ?> minutes for security purposes.
                </p>
                <div style="text-align:center;margin:32px 0;">
                    <a href="<?php echo e($verificationUrl); ?>" style="background-color:#0d47a1;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:999px;font-weight:600;display:inline-block;">Verify Email Address</a>
                </div>
                <p style="margin:0 0 16px 0;line-height:1.6;">
                    If the button above does not work, copy and paste the link below into your browser:
                </p>
                <p style="margin:0 0 24px 0;line-height:1.6;word-break:break-all;">
                    <a href="<?php echo e($rawUrl ?? $verificationUrl); ?>" style="color:#1976d2;text-decoration:none;"><?php echo e($rawUrl ?? $verificationUrl); ?></a>
                </p>
                <p style="margin:0 0 16px 0;line-height:1.6;">
...
<?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\resources\views\mail\verify-email.blade.php ENDPATH**/ ?>