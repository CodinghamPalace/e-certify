<?php # [BlazeFolded]:{flux::menu}:{C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/index.blade.php}:{1772508755} ?>
<?php # [BlazeFolded]:{flux::dropdown}:{C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/dropdown.blade.php}:{1772508755} ?>
<?php
if (!function_exists('_9c9df62c3e30d32f60932bbbfa2d7ac7')):
function _9c9df62c3e30d32f60932bbbfa2d7ac7($__blaze, $__data = [], $__slots = [], $__bound = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'size-4'], [], ['icon', 'variant'], isset($this) ? $this : null); ?>
...
<?php _8140e9c600d47b8e2db576862f9762e5($__blaze, ['class' => 'size-3! hidden group-data-open/disclosure-button:block'], [], [], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
...
<?php _e3d78b844168b76fcf344f0c8c598297($__blaze, ['class' => 'size-3! block group-data-open/disclosure-button:hidden rtl:rotate-180'], [], [], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
                </div>
            </button>
...
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'in-data-flux-menu:text-zinc-400 in-data-flux-menu:dark:text-white/80 in-data-flux-menu:[[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current size-4'], [], ['icon', 'variant'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                        <?php else: ?>
                            <?php echo e($icon); ?>
...
<?php _e3d78b844168b76fcf344f0c8c598297($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current rtl:hidden'], [], ['variant'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
                    <?php $__blaze->ensureCompiled('C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-left.blade.php', $__blaze->compiledPath.'/dfb977ef63be1da3fa9b397eb82c3706.php'); ?>
<?php require_once $__blaze->compiledPath.'/dfb977ef63be1da3fa9b397eb82c3706.php'; ?>
...
<?php _dfb977ef63be1da3fa9b397eb82c3706($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current hidden rtl:inline'], [], ['variant'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
                </div>
            </button>
    ...
    data-flux-menu
>
    <?php $__blaze->ensureCompiled('C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/group.blade.php', $__blaze->compiledPath.'/3e9a4d5ab6fa4d561d1b221c1bce6d4b.php'); ?>
<?php require_once $__blaze->compiledPath.'/3e9a4d5ab6fa4d561d1b221c1bce6d4b.php'; ?>
<?php $__attrs3e9a4d5ab6fa4d561d1b221c1bce6d4b = ['heading' => $heading]; ?>
<?php $__blaze->pushData($__attrs3e9a4d5ab6fa4d561d1b221c1bce6d4b); ?>
<?php $slots3e9a4d5ab6fa4d561d1b221c1bce6d4b = []; ?>
<?php ob_start(); ?>
                    <?php echo e($slot); ?>

                <?php $slots3e9a4d5ab6fa4d561d1b221c1bce6d4b['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($slots3e9a4d5ab6fa4d561d1b221c1bce6d4b); ?>
<?php _3e9a4d5ab6fa4d561d1b221c1bce6d4b($__blaze, $__attrs3e9a4d5ab6fa4d561d1b221c1bce6d4b, $slots3e9a4d5ab6fa4d561d1b221c1bce6d4b, ['heading'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
</ui-menu>
</ui-dropdown>
...
} endif; ?><?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\stubs\resources\views\flux\sidebar\group.blade.php ENDPATH**/ ?>