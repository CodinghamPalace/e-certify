<?php
if (!function_exists('_cc7eb07cc83044923a1f5b1a4bbfc0ef')):
function _cc7eb07cc83044923a1f5b1a4bbfc0ef($__blaze, $__data = [], $__slots = [], $__bound = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__blaze->pushData(['variant' => $iconVariant,'icon' => 'check','class' => $iconClasses,'data-flux-menu-item-icon' => true]); ?>
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['variant' => $iconVariant,'icon' => 'check','class' => $iconClasses,'data-flux-menu-item-icon' => true], [], ['variant', 'class', 'data-flux-menu-item-icon'], isset($this) ? $this : null); ?>
...
<?php require_once $__blaze->compiledPath.'/0855732aafc6286059c5e718eea4a6e5.php'; ?>
<?php $__blaze->pushData(['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $iconTrailingClasses,'data-flux-menu-item-icon' => true]); ?>
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $iconTrailingClasses,'data-flux-menu-item-icon' => true], [], ['icon', 'variant', 'class', 'data-flux-menu-item-icon'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
...
} endif; ?><?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\stubs\resources\views\flux\menu\checkbox\index.blade.php ENDPATH**/ ?>