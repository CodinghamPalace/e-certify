...
<?php # [BlazeFolded]:{flux::radio}:{C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/index.blade.php}:{1772508755} ?>
<?php # [BlazeFolded]:{flux::radio}:{C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/index.blade.php}:{1772508755} ?>
<?php # [BlazeFolded]:{flux::radio}:{C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/index.blade.php}:{1772508755} ?>
<?php # [BlazeFolded]:{flux::radio.group}:{C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/radio/group/index.blade.php}:{1772508755} ?>
<section class="w-full">
    <?php echo $__env->make('partials.settings-heading', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <div class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php echo e(__('Appearance settings')); ?></div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <?php $__blaze->pushData(['xData' => '1', 'variant' => 'segmented', 'xModel' => '$flux.appearance']); $__env->pushConsumableComponentData(['xData' => '1', 'variant' => 'segmented', 'xModel' => '$flux.appearance']); ?><ui-radio-group class="block flex p-1 rounded-lg bg-zinc-800/5 dark:bg-white/10 h-10 p-1" x-data="" x-model="$flux.appearance"  data-flux-radio-group-segmented>
...
<?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\resources\views\livewire\settings\appearance.blade.php ENDPATH**/ ?>