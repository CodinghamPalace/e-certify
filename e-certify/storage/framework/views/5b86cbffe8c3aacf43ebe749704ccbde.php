<?php
if (!function_exists('_5b86cbffe8c3aacf43ebe749704ccbde')):
function _5b86cbffe8c3aacf43ebe749704ccbde($__blaze, $__data = [], $__slots = [], $__bound = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['icon' => $icon,'attributes' => $iconAttributes], [], ['icon', 'attributes'], isset($this) ? $this : null); ?>
...
} endif; ?><?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\stubs\resources\views\flux\checkbox\variants\buttons.blade.php ENDPATH**/ ?>