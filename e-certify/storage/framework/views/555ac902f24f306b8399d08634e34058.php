...
<?php
if (!function_exists('_555ac902f24f306b8399d08634e34058')):
function _555ac902f24f306b8399d08634e34058($__blaze, $__data = [], $__slots = [], $__bound = [], $__this = null) {
$__env = $__blaze->env;
...
<ui-submenu data-flux-menu-submenu>
    <?php $__blaze->ensureCompiled('C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/item.blade.php', $__blaze->compiledPath.'/7c8f4ca953dccbc2da318bbdc85f6825.php'); ?>
<?php require_once $__blaze->compiledPath.'/7c8f4ca953dccbc2da318bbdc85f6825.php'; ?>
<?php $__attrs7c8f4ca953dccbc2da318bbdc85f6825 = ['icon' => $icon,'iconVariant' => $iconVariant]; ?>
<?php $__blaze->pushData($__attrs7c8f4ca953dccbc2da318bbdc85f6825); ?>
<?php $slots7c8f4ca953dccbc2da318bbdc85f6825 = []; ?>
<?php ob_start(); ?>
        <?php echo e($heading); ?>


             <?php $slots7c8f4ca953dccbc2da318bbdc85f6825['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php ob_start(); ?>
...
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['icon' => 'chevron-right','variant' => $iconVariant,'class' => $iconClasses->add('rtl:hidden')], [], ['variant', 'class'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
...
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['icon' => 'chevron-left','variant' => $iconVariant,'class' => $iconClasses->add('hidden rtl:inline')], [], ['variant', 'class'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
            <?php endif; ?>
        <?php $slots7c8f4ca953dccbc2da318bbdc85f6825['suffix'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($slots7c8f4ca953dccbc2da318bbdc85f6825); ?>
<?php _7c8f4ca953dccbc2da318bbdc85f6825($__blaze, $__attrs7c8f4ca953dccbc2da318bbdc85f6825, $slots7c8f4ca953dccbc2da318bbdc85f6825, ['icon', 'iconVariant'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\stubs\resources\views\flux\menu\submenu.blade.php ENDPATH**/ ?>