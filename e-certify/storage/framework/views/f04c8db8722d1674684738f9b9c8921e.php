<?php
if (!function_exists('_f04c8db8722d1674684738f9b9c8921e')):
function _f04c8db8722d1674684738f9b9c8921e($__blaze, $__data = [], $__slots = [], $__bound = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrsca934b3590aaef73dcdf79070fb76d93 = ['attributes' => $attributes->class($classes),'data-flux-navlist-item' => true]; ?>
...
<?php _0855732aafc6286059c5e718eea4a6e5($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => 'size-4!'], [], ['icon', 'variant'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
...
<?php $__attrs7c83e9dba299c1a66a32e92ee51a16e3 = ['attributes' => $badgeAttributes]; ?>
...
<?php _ca934b3590aaef73dcdf79070fb76d93($__blaze, $__attrsca934b3590aaef73dcdf79070fb76d93, $slotsca934b3590aaef73dcdf79070fb76d93, ['attributes', 'data-flux-navlist-item'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH C:\Users\Jikuma\Documents\coding-projects\e-certify\e-certify\e-certify\vendor\livewire\flux\src/../stubs/resources/views/flux/navlist/item.blade.php ENDPATH**/ ?>